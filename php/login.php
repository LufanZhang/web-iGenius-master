...
<title>iGeniusStock-Login</title>
...
<tr>
<td width="100%" style="border-style: none; border-width: medium">
<p style="margin: 1 7"><b><font face="Arial" size="2" color="#0D4416"><a href='register.php'>Register</a></font></b></td>
</tr>
<tr>
<td width="100%" style="border-style: none; border-width: medium">
...
<p align="center"><b><font face="Arial" size="5" color="#0D4416">Please Sign in to Begin</font></b></p>
<p><font face="Verdana" size="2" color="#0D4416">&nbsp;</font></p>

<!-- Form Code Start -->
<div id='fg_membersite'>
<form id='login' action="<?php echo $fgmembersite->GetSelfScript(); ?>" method='post' accept-charset='UTF-8'>
<fieldset >
<legend><font face="Arial" size="4" color="#0D4416">Login</font></legend>

<input type='hidden' name='submitted' id='submitted' value='1'/>

<div class='short_explanation'><font face="Verdana" size="1">* required fields</font></div>

<div><span class='error'><?php echo $fgmembersite->GetErrorMessage(); ?></span></div>
<div class='container'>
    <label for='username' ><font face="Verdana" size="2" color="#0D4416">UserName*:</font></label><br/>
    <input type='text' name='username' id='username' value='<?php echo $fgmembersite->SafeDisplay('username') ?>' maxlength="50" /><br/>
    <span id='login_username_errorloc' class='error'></span>
</div>
<div class='container'>
    <label for='password' ><font face="Verdana" size="2" color="#0D4416">Password*:</font></label><br/>
...
<div class='short_explanation'><a href='reset-pwd-req.php'><font face="Verdana" size="1">Forgot Password?</font></a></div>
</fieldset>
</form>
